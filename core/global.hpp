...
public:
    ...
    static string hosts_file __attribute__((weak));
...
int Global::num_servers = 4;    // the number of servers
int Global::num_threads = 16;    // the number of threads per server (incl. proxy and engine)
...
int Global::rdma_buf_size_mb = 64; // 设为64, LAION设为512
...
// kvstore
int Global::memstore_size_gb = 20; // 64
/**
